...
class ConcertQueryService {
    ...
    ConcertQueryService(ConcertRepository concertRepository, ConcertScheduleRepository concertScheduleRepository,
    ...
    PageResponse<ConcertSummaryResponse> concerts(int page, int size) {
    ...
    ConcertDetailResponse detail(long concertId, Long memberId) {
