...
import com.encore.ticket.booking.api.CompletedPayment;
...
class ReservationQueryService {
    ...
    ReservationQueryService(ReservationRepository reservationRepository, SeatCatalogReader seatCatalogReader,
    ...
    PageResponse<ReservationSummaryResponse> reservationsOf(Long memberId, int page, int size) {
    ...
    ReservationDetailResponse detail(Long reservationId, Long memberId, CompletedPayment payment) {
