...
class ReservationCreateService {
    ...
    ReservationCreateService(ReservationRepository reservationRepository, HoldReader holdReader,
    ...
    CreateResult create(String holdId, Long memberId, PaymentAttemptState lastAttempt) {
