package com.encore.ticket.core.booking.hold;
...
class SeatMapService {
    ...
    SeatMapService(SeatHoldRepository seatHoldRepository, SeatCatalogReader seatCatalogReader, Clock clock) {
        this.seatHoldRepository = seatHoldRepository;
        this.seatCatalogReader = seatCatalogReader;
        this.clock = clock;
    }

    SeatMapResponse seatMap(Long scheduleId) {
